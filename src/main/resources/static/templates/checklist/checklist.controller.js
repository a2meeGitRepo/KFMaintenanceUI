(function() {
	...
	checklistController.$inject = [ '$http','$state', 'checklistService', '$uibModal', '$log',
			'$scope', 'toastr', 'ApiEndpoint','machine_mstService', 'fileUpload','$filter', '$window'];
	...
	/* @ngInject */
	function checklistController($http,$state, checklistService, $uibModal, $log, $scope, toastr, ApiEndpoint, machine_mstService, fileUpload, $window) {
